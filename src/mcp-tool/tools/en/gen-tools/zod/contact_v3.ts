  ...
  schema: {
    path: z.object({
      job_title_id: z
        .string()
        .describe(
          'Job title ID. You can call the [Get tenant job title list] interface to obtain the job ID',
        )
        .optional(),
    }),
    useUAT: z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
  ...
  schema: {
    data: z.object({
      ...
      country: z
        .string()
        .describe(
          'Country or region code. Refer to the [list of country/region codes] for details',
        )
        .optional(),
                ...
                generic_user: z
                  .object({
                    id: z
                      .string()
                      .describe(
                        'The user ID of the referrer.- The ID type is consistent with the value of the query parameter `user_id_type`.- For how to obtain the user ID, please refer to [How to obtain different user IDs]',
                      ),
                    type: z
                      .number()
                      .describe(
  ...
  schema: {
    path: z.object({
      work_city_id: z
        .string()
        .describe(
          'Work city ID. You can call the [Get tenant work city list] interface to get the work city ID',
        )
        .optional(),
    }),
    useUAT: z.boolean().describe('Use user access token, otherwise use tenant access token').optional(),
